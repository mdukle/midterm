...
This assignment was done to further my understanding of creating virtual environments, setting up FastAPI, creating CRUD API endpoints, and connecting frontend with backend using HTTP calls, combining these tasks into one overall application.
